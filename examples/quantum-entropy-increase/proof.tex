...
\textbf{Lean 4 Verification:} & Fully verified (0 sorries, 0 axioms) \\
\end{tabular}
\end{center}
...
\end{enumerate}
\leanref{EntropyIncrease.lean}{133}
\end{proof}

\section{Lean 4 Formalization}

The proof has been fully formalized in Lean 4 with zero sorries and zero axioms. All lemmas and theorems are completely proved, including the diagonal Pauli expansion, spectral distribution characterization, and the main entropy increase theorem.
...
\texttt{diagonal\_pauli\_expansion} & theorem & 93 & Proved \\
\texttt{diagonalObs\_spectralEntropy\_eq} & theorem & ZIndexEquiv.lean:78 & Proved \\
\texttt{diagonalObs\_quantumInfluence\_eq} & theorem & ZIndexEquiv.lean:95 & Proved \\
\texttt{th\_transform\_entropy\_increase} & theorem & 81 & Proved \\
\texttt{th\_transform\_influence\_preserved} & theorem & 99 & Proved \\
...
\vspace{1em}
\textbf{Summary:} All 19 theorems/lemmas fully proved, 0 axioms, 0 sorries.
